...
def haSendDiscoveryMessages(client, userdata, message):
	if (message.payload.decode()=='online'):
		...
		hassio.addNumber('hot_water_temp_day',"Température ECS Jour",'hotWater/dayTemp','hotWater/dayTemp/set',10,80,0.5,"°C");
		hassio.addNumber('hot_water_temp_night',"Température ECS Nuit",'hotWater/nightTemp','hotWater/nightTemp/set',10,80,0.5,"°C");
